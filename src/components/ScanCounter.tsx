...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 13, fontWeight: '800', marginBottom: 10 },
  counterDisplay: {
    flexDirection: 'row',
  ...
  value: { fontSize: 20, fontWeight: '800', color: '#00758F' },
  btnRow: { flexDirection: 'row', gap: 10, marginTop: 12 },
  btnPrimary: { flex: 1, backgroundColor: '#00758F', padding: 10, borderRadius: 8, alignItems: 'center' },
  btnSecondary: { flex: 1, backgroundColor: '#E2E8F0', padding: 10, borderRadius: 8, alignItems: 'center' },
  btnText: { color: '#FFFFFF', fontWeight: '700' },
  btnSecText: { color: '#334155', fontWeight: '700' },
});
