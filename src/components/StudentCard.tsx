...
const styles = StyleSheet.create({
  ...
  idNumber: { fontFamily: 'monospace', fontSize: 12, color: '#00758F' },
  program: { fontSize: 12, color: '#475569' },
  yearLevel: { fontSize: 11, color: '#64748B' },
  campus: { fontSize: 11, color: '#64748B', marginTop: 6 },
});
